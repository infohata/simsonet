"""
Django settings for simsonet project.
...
SECRET_KEY = 'django-insecure-r$8lv##as7=$x!9(n5j%n@(#yjlbwtvf_c((8(oj4s!h%g#z=t'
...
WSGI_APPLICATION = 'simsonet.wsgi.application'
